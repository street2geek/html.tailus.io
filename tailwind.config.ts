...
module.exports = withTV({
    content: ['./src/**/*.{astro,html,js,jsx,md,mdx,svelte,ts,tsx,vue}', './node_modules/@tailus/themer/dist/components/**/*.{js,ts}'],
    darkMode: 'selector',
    ...
    plugins: [components, shade, palette, animations, containerQueries],
}) satisfies Config
