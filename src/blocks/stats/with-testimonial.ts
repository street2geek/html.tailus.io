        ...
        <div class="grid gap-6 sm:grid-cols-2 md:gap-12 lg:gap-24">
            <div>
                ...
                <div class="mb-12 mt-12 grid grid-cols-2 gap-2 md:mb-0">
                    <div class="space-y-4">
                        <div class="bg-linear-to-r from-(--title-text-color) to-gray-600 bg-clip-text text-5xl font-bold text-transparent dark:to-gray-800">+1200</div>
                        <p class="text-body">Stars on GitHub</p>
                    </div>
                    <div class="space-y-4">
                        <div class="bg-linear-to-r from-(--title-text-color) to-gray-600 bg-clip-text text-5xl font-bold text-transparent dark:to-gray-800">+500</div>
                    ...
                    <div>
                        ...
                        <div className="mb-12 mt-12 grid grid-cols-2 gap-2 md:mb-0">
                            <div className="space-y-4">
                                <div className="bg-linear-to-r from-(--title-text-color) to-gray-600 bg-clip-text text-5xl font-bold text-transparent dark:to-gray-800">+1200</div>
                                <p className="text-body">Stars on GitHub</p>
                            </div>
                            <div className="space-y-4">
                                <div className="bg-linear-to-r from-(--title-text-color) to-gray-600 bg-clip-text text-5xl font-bold text-transparent dark:to-gray-800">+500</div>
