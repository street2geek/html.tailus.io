    ...
    <div class="mx-auto max-w-5xl px-6">
        <div class="text-center">
            ...
            <form action="post" class="mx-auto mt-10 max-w-sm lg:my-12">
                <div class="bg-ui relative grid items-center rounded-[calc(var(--btn-radius)+0.5rem)] border pr-2 shadow-2xs shadow-gray-950/5 outline-2 outline-offset-2 outline-primary-600 [grid-template-columns:1fr_auto] has-[input:focus]:outline">
                    ...
                    <input autocomplete="email" placeholder="Your mail address" class="h-12 w-full bg-transparent pl-11 text-sm focus:outline-hidden" type="email" />
