...
const htmlCode = `<section>
    <div class="py-32">
        <div class="mx-auto px-6 max-w-5xl">
            <div class="grid gap-12 md:gap-0 md:grid-cols-2 items-center lg:gap-12">
                <div class="lg:pr-12">
                    <div class="md:pr-6 lg:pr-0">
                        <h2 class="text-3xl text-title font-semibold">All your favorite dev tools work with Ada</h2>
                        <p class="mt-6 text-body">Harum quae dolore inventore repudiandae? orrupti aut temporibus assumenda atque ab, accusamus sit, molestiae veniam laboriosam pariatur.</p>
                    </div>
                    <ul class="mt-8 divide-y border-y *:py-3 *:flex *:items-center *:gap-3">
                        <li>
                ...
                <div class="overflow-hidden p-3 card variant-outlined">
                    ...
                    <div class="flex gap-3 px-(--card-padding) *:aspect-square *:p-4">
                        <div class="card variant-outlined">
...
const nextjsCode = `export default function FeaturesSection() {
    return (
        <section>
            <div className="py-32">
                    ...
                    <div className="grid gap-12 md:gap-0 md:grid-cols-2 items-center lg:gap-12">
                        <div className="lg:pr-12">
                            <div className="md:pr-6 lg:pr-0">
                                <h2 className="text-3xl text-title font-semibold">All your favorite dev tools work with Ada</h2>
                                <p className="mt-6 text-body">Harum quae dolore inventore repudiandae? orrupti aut temporibus assumenda atque ab, accusamus sit, molestiae veniam laboriosam pariatur.</p>
                            </div>
                            <ul className="mt-8 divide-y border-y *:py-3 *:flex *:items-center *:gap-3">
                                ...
                                <li>
                                    <svg className="size-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                        <path fill="currentColor" d="M8 9.5A1.25 1.25 0 1 0 8 12a1.25 1.25 0 0 0 0-2.5m4 0a1.25 1.25 0 1 0 0 2.5a1.25 1.25 0 0 0 0-2.5m2.75 1.25a1.25 1.25 0 1 1 2.5 0a1.25 1.25 0 0 1-2.5 0"/>
                                        <path fill="currentColor" fillRule="evenodd" d="M16.1 4.593a50.577 50.577 0 0 0-8.098-.04l-.193.015A4.93 4.93 0 0 0 3.25 9.483V18a.75.75 0 0 0 1.105.66l3.91-2.101a1.25 1.25 0 0 1 .593-.149h8.976c1.132 0 2.102-.81 2.305-1.923c.412-2.257.444-4.567.096-6.835l-.102-.669a2.666 2.666 0 0 0-2.408-2.252zM8.116 6.049a49.078 49.078 0 0 1 7.858.038l1.624.139c.536.046.972.453 1.053.985l.103.668a19.165 19.165 0 0 1-.09 6.339a.843.843 0 0 1-.829.692H8.858a2.75 2.75 0 0 0-1.302.328L4.75 16.746V9.483a3.43 3.43 0 0 1 3.171-3.42z" clipRule="evenodd"/>
                                    </svg>
                                    Fast response time
                                </li>
                                <li>
                                    <svg className="size-5" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 14 14">
                                        <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M.5 7.08h2.19a.52.52 0 0 0 .45-.27l1.8-3.6a.49.49 0 0 1 .49-.27a.48.48 0 0 1 .43.35l2.23 7.42a.5.5 0 0 0 .46.36a.5.5 0 0 0 .45-.32l1.37-3.35a.51.51 0 0 1 .47-.32h2.66"/>
                                    </svg>
                                    Menitoring and analytics
                                </li>
                                <li >
                        ...
                        <div className="overflow-hidden p-3 card variant-outlined">
                            ...
                            <div className="flex gap-3 px-(--card-padding) *:aspect-square *:p-4">
                                ...
                                <div className="card variant-soft">
                                    <svg className="size-7" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 15 15">
                                        <path fill="currentColor" d="m4.5 4.5l.405-.293A.5.5 0 0 0 4 4.5zm3 9.5A6.5 6.5 0 0 1 1 7.5H0A7.5 7.5 0 0 0 7.5 15zM14 7.5A6.5 6.5 0 0 1 7.5 14v1A7.5 7.5 0 0 0 15 7.5zM7.5 1A6.5 6.5 0 0 1 14 7.5h1A7.5 7.5 0 0 0 7.5 0zm0-1A7.5 7.5 0 0 0 0 7.5h1A6.5 6.5 0 0 1 7.5 1zM5 12V4.5H4V12zm-.905-7.207l6.5 9l.81-.586l-6.5-9zM10 4v6h1V4z"/>
                                    </svg>
                                </div>
                                <div className="card variant-outlined">
                                    <svg className="size-7" xmlns="http://www.w3.org/2000/svg" width="1.53em" height="1em" viewBox="0 0 256 168">
                                        <path fill="currentColor" d="M143.618 167.029h95.166c3.023 0 5.992-.771 8.61-2.237a16.963 16.963 0 0 0 6.302-6.115a16.324 16.324 0 0 0 2.304-8.352c0-2.932-.799-5.811-2.312-8.35L189.778 34.6a16.966 16.966 0 0 0-6.301-6.113a17.626 17.626 0 0 0-8.608-2.238c-3.023 0-5.991.772-8.609 2.238a16.964 16.964 0 0 0-6.3 6.113l-16.342 27.473l-31.95-53.724a16.973 16.973 0 0 0-6.304-6.112A17.638 17.638 0 0 0 96.754 0c-3.022 0-5.992.772-8.61 2.237a16.973 16.973 0 0 0-6.303 6.112L2.31 141.975a16.302 16.302 0 0 0-2.31 8.35c0 2.932.793 5.813 2.304 8.352a16.964 16.964 0 0 0 6.302 6.115a17.628 17.628 0 0 0 8.61 2.237h59.737c23.669 0 41.123-10.084 53.134-29.758l29.159-48.983l15.618-26.215l46.874 78.742h-62.492zm-67.64-26.24l-41.688-.01L96.782 35.796l31.181 52.492l-20.877 35.084c-7.976 12.765-17.037 17.416-31.107 17.416"/>
                                    </svg>
                                </div>
                                <div className="card variant-outlined">
