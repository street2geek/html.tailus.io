...
const htmlCode = `<section class="py-20">
    <div class="mx-auto max-w-5xl space-y-12 px-6">
        ...
        <div class="relative">
            ...
            <div class="absolute -inset-20 bg-linear-to-b from-gray-50 via-transparent to-gray-50 sm:-inset-40 dark:from-gray-950 dark:via-transparent dark:to-gray-950"></div>
            <div class="absolute -inset-20 bg-linear-to-r from-gray-50 via-transparent to-gray-50 sm:-inset-40 dark:from-gray-950 dark:via-transparent dark:to-gray-950"></div>
            <div class="tls-shadow-lg rounded-card relative overflow-hidden shadow-gray-950/[0.03]">
                <img class="scale-105" src="/blocks/cat.png" alt="" />
            </div>
        </div>

        <div class="relative grid grid-cols-2 gap-x-3 gap-y-6 sm:max-w-full sm:gap-4 lg:grid-cols-4">
            <div class="space-y-3">
                <div class="flex items-center gap-2">
                    ...
                    <h3 class="text-title text-sm font-medium">Faaast</h3>
                </div>
                <p class="text-body text-sm">It supports an entire helping developers and innovate.</p>
            </div>
            <div class="space-y-2">
                <div class="flex items-center gap-2">
                    <svg class="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <h3 class="text-title text-sm font-medium">Powerful</h3>
                </div>
                <p class="text-body text-sm">It supports an entire helping developers and businesses.</p>
            </div>
            <div class="space-y-2">
                <div class="flex items-center gap-2">
                    <svg class="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <h3 class="text-title text-sm font-medium">Security</h3>
                </div>
                <p class="text-body text-sm">It supports an helping developers businesses innovate.</p>
            </div>
            <div class="space-y-2">
                <div class="flex items-center gap-2">
                    <svg class="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <h3 class="text-title text-sm font-medium">Control</h3>
                </div>
                <p class="text-body text-sm">It supports helping developers and businesses innovate.</p>
            </div>
        </div>
    </div>
</section>`
        ...
        <section className="py-20">
            <div className="mx-auto max-w-5xl space-y-12 px-6">
                ...
                <div className="relative">
                    ...
                    <div className="absolute -inset-20 bg-linear-to-b from-gray-50 via-transparent to-gray-50 sm:-inset-40 dark:from-gray-950 dark:via-transparent dark:to-gray-950"></div>
                    <div className="absolute -inset-20 bg-linear-to-r from-gray-50 via-transparent to-gray-50 sm:-inset-40 dark:from-gray-950 dark:via-transparent dark:to-gray-950"></div>
                    <div className="tls-shadow-lg rounded-card relative overflow-hidden shadow-gray-950/[0.03]">
                        <img className="scale-105" src="/blocks/cat.png" alt="" />
                    </div>
                </div>

                <div className="relative grid grid-cols-2 gap-x-3 gap-y-6 sm:max-w-full sm:gap-4 lg:grid-cols-4">
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center gap-2">
                            ...
                            <h3 className="text-title text-sm font-medium">Security</h3>
                        </div>
                        <p className="text-body text-sm">It supports an helping developers businesses innovate.</p>
                    </div>
                    <div className="space-y-2">
                        <div className="flex items-center gap-2">
                            <svg className="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <h3 className="text-title text-sm font-medium">Control</h3>
                        </div>
                        <p className="text-body text-sm">It supports helping developers and businesses innovate.</p>
                    </div>
                </div>
            </div>
        </section>
...
export const centerScreenshotCode: Code = {
    html: htmlCode,
    astro: htmlCode,
    nextjs: nextjsCode,
    nuxtjs: nuxtjsCode,
