...
const htmlCode = `<header class="mx-auto flex h-16 items-center px-6 2xl:max-w-7xl">
...
<main class="grid min-h-[calc(100vh-4rem)] [grid-template-rows:1fr_auto]">
    <section class="mx-auto flex w-full max-w-xs items-center">
        <div class="w-full">
            ...
            <form action="/signup" method="post" class="mt-12">
                <button type="button" class="btn variant-outlined sz-md w-full">
                    ...
                    >
                    <span class="btn-label">Sign up with GitHub</span>
                </button>
                <hr class="my-4 border-dashed" />
                <div class="mb-8 space-y-4" data-shade="950">
                    <div class="field">
                        <label for="email">Email</label>
                        <input class="input variant-mixed sz-md" type="email" id="email" name="email" required />
                    </div>
                    <div class="field">
                        <label for="password">Password</label>
                        <input class="input variant-mixed sz-md" type="password" id="password" name="password" required />
                    </div>
                </div>
    ...
    <section class="border-t bg-gray-50 dark:bg-gray-900/50">
...
export default function SignUpPage(){
    return (
        <>
            <header className="mx-auto flex h-16 items-center px-6 2xl:max-w-7xl">
            ...
            <main className="grid min-h-[calc(100vh-4rem)] [grid-template-rows:1fr_auto]">
                <section className="mx-auto flex w-full max-w-xs items-center">
                    <div className="w-full">
                        <h1 className="text-title text-xl font-semibold">Sign Up</h1>
                        <form action="/signup" method="post" className="mt-12">
                            <button type='button' className="btn variant-outlined sz-md w-full">
                                <svg className="size-4" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"
                                    ><path fill="currentColor" d="M3.064 7.51A10 10 0 0 1 12 2c2.695 0 4.959.991 6.69 2.605l-2.867 2.868C14.786 6.482 13.468 5.977 12 5.977c-2.605 0-4.81 1.76-5.595 4.123c-.2.6-.314 1.24-.314 1.9s.114 1.3.314 1.9c.786 2.364 2.99 4.123 5.595 4.123c1.345 0 2.49-.355 3.386-.955a4.6 4.6 0 0 0 1.996-3.018H12v-3.868h9.418c.118.654.182 1.336.182 2.045c0 3.046-1.09 5.61-2.982 7.35C16.964 21.105 14.7 22 12 22A9.996 9.996 0 0 1 2 12c0-1.614.386-3.14 1.064-4.49"></path></svg
                                >
                                <span className="btn-label">Sign up with GitHub</span>
                            </button>
                            <hr className="my-4 border-dashed" />
                            <div className="mb-8 space-y-4" data-shade="950">
                                <div className="field">
                                    <label htmlFor="email">Email</label>
                                    <input className="input variant-mixed sz-md" type="email" id="email" name="email" required />
                                </div>
                                <div className="field">
                                    <label htmlFor="password">Password</label>
                                    <input className="input variant-mixed sz-md" type="password" id="password" name="password" required />
                                </div>
                            </div>
                ...
                <section className="border-t bg-gray-50 dark:bg-gray-900/50">
                    <div className="mx-auto max-w-5xl px-6 py-6">
                        <span className="text-caption block text-center text-sm">By signing up, you agree our <Link href="" className="link variant-animated intent-info">Terms of use</Link></span>
                    </div>
                </section>
            </main>
        </>
