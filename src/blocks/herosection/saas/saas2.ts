...
const htmlCode = `<header>
    <nav id="navbar" class="group fixed z-20 w-full border-b border-dashed bg-white backdrop-blur-xs md:relative dark:bg-gray-950/50 lg:dark:bg-transparent">
            ...
            <div class="-mr-16 pl-16 [perspective:1000px] lg:-mr-56 lg:pl-56">
                <div class="[transform:rotateX(20deg);]">
                    <div class="relative [transform:skewX(.36rad);] lg:h-[44rem]">
                        <div class="absolute -inset-16 z-1 bg-linear-to-b from-white via-transparent to-white sm:-inset-32 dark:from-gray-950 dark:via-transparent dark:to-gray-950"></div>
                        <div class="absolute -inset-16 z-1 bg-linear-to-r from-white via-transparent to-white sm:-inset-32 dark:from-gray-950 dark:via-transparent dark:to-gray-950"></div>
                        <div data-shade="glassy" class="absolute -inset-16 bg-[linear-gradient(to_right,var(--ui-border-color)_1px,transparent_1px),linear-gradient(to_bottom,var(--ui-border-color)_1px,transparent_1px)] bg-[size:24px_24px] [--ui-border-color:var(--color-gray-400)] sm:-inset-32 dark:[--ui-border-color:var(--color-white)]/20"></div>
                        <div class="absolute inset-0 z-11 bg-linear-to-l from-white dark:from-gray-950"></div>
                        <div class="absolute inset-0 z-2 h-full w-full items-center px-5 py-24 [--layer-color:var(--color-white)] [background:radial-gradient(125%_125%_at_50%_10%,transparent_40%,var(--layer-color)_100%)] dark:[--layer-color:var(--color-gray-950)]"></div>
                        <div class="absolute inset-0 z-2 h-full w-full items-center px-5 py-24 [--layer-color:var(--color-white)] [background:radial-gradient(125%_125%_at_50%_10%,transparent_40%,var(--layer-color)_100%)] dark:[--layer-color:var(--color-gray-950)]"></div>
...
export default function HeroSection() {
    ...
    return (
        <>
            <header>
                <nav data-state={menuState && 'active'} className="group fixed z-20 w-full border-b border-dashed bg-white backdrop-blur-xs md:relative dark:bg-gray-950/50 lg:dark:bg-transparent">
                        ...
                        <div className="-mr-16 pl-16 [perspective:1000px] lg:-mr-56 lg:pl-56">
                            <div className="[transform:rotateX(20deg);]">
                                <div className="relative [transform:skewX(.36rad);] lg:h-[44rem]">
                                    <div className="absolute -inset-16 z-1 bg-linear-to-b from-white via-transparent to-white sm:-inset-32 dark:from-gray-950 dark:via-transparent dark:to-gray-950"></div>
                                    <div className="absolute -inset-16 z-1 bg-linear-to-r from-white via-transparent to-white sm:-inset-32 dark:from-gray-950 dark:via-transparent dark:to-gray-950"></div>
                                    <div data-shade="glassy" className="absolute -inset-16 bg-[linear-gradient(to_right,var(--ui-border-color)_1px,transparent_1px),linear-gradient(to_bottom,var(--ui-border-color)_1px,transparent_1px)] bg-[size:24px_24px] [--ui-border-color:var(--color-gray-400)] sm:-inset-32 dark:[--ui-border-color:var(--color-white)]/20"></div>
                                    <div className="absolute inset-0 z-11 bg-linear-to-l from-white dark:from-gray-950"></div>
                                    <div className="absolute inset-0 z-2 h-full w-full items-center px-5 py-24 [--layer-color:var(--color-white)] [background:radial-gradient(125%_125%_at_50%_10%,transparent_40%,var(--layer-color)_100%)] dark:[--layer-color:var(--color-gray-950)]"></div>
                                    <div className="absolute inset-0 z-2 h-full w-full items-center px-5 py-24 [--layer-color:var(--color-white)] [background:radial-gradient(125%_125%_at_50%_10%,transparent_40%,var(--layer-color)_100%)] dark:[--layer-color:var(--color-gray-950)]"></div>
