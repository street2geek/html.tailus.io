...
@layer components {
    ...
    .field{
        @apply relative space-y-2.5 has-disabled:*:opacity-50 has-disabled:*:pointer-events-none has-[:user-invalid]:[--caption-text-color:var(--color-danger-400)]
    }
    ...
    .input.variant-soft, .textarea.variant-soft {
        @apply outline-hidden bg-(--ui-soft-bg) focus:brightness-105
    }
    ...
    .input.variant-bottomOutlined, .textarea.variant-bottomOutlined {
        @apply rounded-none bg-transparent focus:outline-hidden border-b focus:border-(--input-outline) focus:border-b-2
    }
    ...
    .radio-indicator{
        @apply absolute inset-0 m-auto size-2 rounded-full peer-checked:shadow-2xs peer-checked:shadow-gray-950/25 transition duration-300 bg-white scale-75 opacity-0 group-hover:opacity-25 peer-checked:scale-100 peer-checked:opacity-100
    }
    ...
    .callout.variant-warning{
        @apply bg-warning-500/5 [--title-text-color:var(--color-white)]
    }
    .callout.variant-danger{
        @apply bg-danger-500/5 [--title-text-color:var(--color-white)]
    }
    .callout.variant-neutral{
        @apply bg-gray-500/5 [--title-text-color:var(--color-white)]
    }
}`
