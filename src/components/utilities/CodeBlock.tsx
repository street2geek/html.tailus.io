...
export const CodeBlock: React.FC<CodeBlockProps> = ({ className, codeBlocks, asUIBlock }) => {
    ...
    return (
        <div className={twMerge('group/snippet relative h-full w-full overflow-hidden rounded-(--card-radius) border bg-gray-200 dark:bg-transparent', asUIBlock && 'dark:shadow-2xs dark:shadow-gray-950', className)}>
