...
<div className="space-y-20">
    ...
    <div>
        Adjust the border radius of your components using the `data-rounded` attribute. Start with importing and adding the `rounded-xs` plugin to your config's `plugins` array
