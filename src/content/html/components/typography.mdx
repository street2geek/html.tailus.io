...
<div className="space-y-20">
    ...
    <div>
        ...
        <PreviewBlock codeBlocks={
            ...
            code:`<div class="space-y-6">
    <h1 class="text-4xl text-display font-bold lg:text-5xl">Build Custom Web UIs</h1>
    <h1 class="text-4xl text-display font-bold lg:text-5xl">Build <span class="text-transparent bg-clip-text bg-linear-to-r from-primary-600 to-accent-400">Custom</span> Web UIs</h1>
</div>`,
              lang: "html"
          }]}>
            ...
            <div class="space-y-6">
                ...
                <span class="text-4xl block text-display font-bold lg:text-5xl">Build <span class="text-transparent bg-clip-text bg-linear-to-r from-primary-600 to-accent-400">Custom</span> Web UIs</span>
            </div>
        </PreviewBlock>
    </div>
