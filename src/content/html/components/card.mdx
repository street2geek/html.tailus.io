...
<div className="space-y-20">
    ...
    <div class="mt-16">
        ...
        <div class="mt-3 progress sz-sm relative">
            <div class="progress-indicator bg-linear-to-r from-primary-600 to-accent-500 w-[60%]"></div>
        </div>
        <div class="w-[60%] blur-xs h-6 bg-linear-to-b from-accent-500/10 to-transparent"></div>
    </div>
</div>`,
              lang: "html"
          }]}>
